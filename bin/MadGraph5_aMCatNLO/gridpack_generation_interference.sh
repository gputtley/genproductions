...
make_gridpack () {
    ...
    echo "copying custom matrix*.f files"
    cp ../../../../vlq_unmatched_interference_mods/matrix*.f ./SubProcesses/P1_qq_ll/.
    ...
    #   set -e
      ...
      cp $PRODHOME/runcmsgrid_LO_interference.sh ./runcmsgrid.sh
    fi
