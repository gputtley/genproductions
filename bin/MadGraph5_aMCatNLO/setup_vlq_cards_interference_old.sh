...
do
  ...
  do
    ...
    do
      ...
      echo "generate p p > ta+ ta- / zp gp NP=2" >> "${filename}_proc_card.dat"
      ...
      # produce gridpacks
      eval "./gridpack_generation_interference.sh ${i}_${j}_mU${mass}_gU1_interference${name_extra} cards/vlq/${i}_${j}_mU${mass}_gU1_interference${name_extra}"
    done
  done
done
