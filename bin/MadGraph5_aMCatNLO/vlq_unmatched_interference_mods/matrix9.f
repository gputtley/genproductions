...
C     
C     Process: d~ b > ta- ta+ NP<=2 / zp gp @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV2_3(W(1,4),W(1,1),GC_21,MDL_MVLQ, FK_MDL_WVLQ,W(1,5))
...
C          ENDDO
C          DO N = 1, NAMPSO
C            IF (CHOSEN_SO_CONFIGS(SQSOINDEX9(M,N))) THEN
C              MATRIX9 = MATRIX9 + ZTEMP*DCONJG(JAMP(I,N))/DENOM(I)
C            ENDIF
C          ENDDO
C        ENDDO
C      ENDDO
