...
C     
C     Process: s~ b > ta- ta+ NP<=2 / zp gp @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV2_3(W(1,4),W(1,1),GC_22,MDL_MVLQ, FK_MDL_WVLQ,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_3_0(W(1,2),W(1,3),W(1,5),GC_24,GC_25,AMP(1))
...
C          ENDDO
C          DO N = 1, NAMPSO
C            IF (CHOSEN_SO_CONFIGS(SQSOINDEX10(M,N))) THEN
C              MATRIX10 = MATRIX10 + ZTEMP*DCONJG(JAMP(I,N))/DENOM(I)
C            ENDIF
C          ENDDO
C        ENDDO
C      ENDDO
