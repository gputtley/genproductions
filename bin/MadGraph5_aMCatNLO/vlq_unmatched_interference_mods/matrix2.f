...
C     
C     Process: s s~ > ta- ta+ NP<=2 / zp gp @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3(W(1,1),W(1,3),GC_22,MDL_MVLQ, FK_MDL_WVLQ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,4),W(1,2),W(1,5),GC_22,AMP(3))
...
C subtract SM-only and VLQ-only to get only SM-VLQ interference
      ...
      MATRIX2 = MATRIX2 - MATRIX_SM - MATRIX_VLQ
